    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="mb-4">
            <strong>Content Use:</strong> All content is Sakia's property. No
            reproduction or use is allowed without permission.
          </p>
          <p className="mb-4">
            <strong>Conduct:</strong> Use our site lawfully and respectfully.
            Any harmful activity is prohibited.
          </p>
          <p className="mb-4">
            <strong>Privacy:</strong> Review our Privacy Policy for details on
            data handling.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            <strong>Liability:</strong> Sakia isn't liable for any damages from
            using the site.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            <strong>Contact:</strong> Questions? Reach us at info@sakia.io.
          </p>
        </motion.div>
      </motion.div>
    </motion.div>
