  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 mb-4 dark:text-white/80 text-sm">
          Please fill out the form below to become a client.
        </p>
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <button
            type="submit"
            className="custom-button group flex items-center justify-center gap-2 h-10 w-28 rounded-full outline-none transition-all focus:scale-110 hover:scale-110 active:scale-105 disabled:scale-100 disabled:opacity-65 self-center text-sm"
          >
            Submit
          </button>
        </form>
